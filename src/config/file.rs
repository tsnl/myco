...
//! ([`crate::machines::harness`]).

use std::collections::BTreeMap;
use std::path::Path;

use crate::models::{Effort, Protocol, ThinkingMode};
...
pub struct ModelEntry {
    ...
    /// ([`crate::config::DEFAULT_AUTO_COMPACT_FRACTION`]).
    #[serde(default)]
    ...
    /// [`crate::config::DEFAULT_MAX_TRUNCATED_RESUMES`].
    #[serde(default)]
