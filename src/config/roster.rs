...
//! access tokens live in `crate::auth::AuthStore`, which the server seeds from
...
pub fn resolve_roster_path(
    ...
    Ok(crate::core::data_root()?.join("server.toml"))
}
...
"#;
    ...
    fn the_roster_path_falls_back_from_override_to_env_to_home() {
        ...
        let _home = crate::test_support::temp_home("roster-path");
