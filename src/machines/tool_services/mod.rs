...
//!
//! Registered on a [`crate::machines::host::HostWorker`]. The **standard** catalog is the same on
...
pub use bash_service::{BashService, ShellLock, ShellOverview, ShellScreen, ShellTail};
