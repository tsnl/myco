...
pub struct Config {
    ...
    /// `max_soul_bytes`, default [`myco_prompts::DEFAULT_MAX_SOUL_BYTES`]).
    /// Passed to [`myco_prompts::agent_prompt_epilogue`] at every model
...
impl Config {
    ...
    pub fn resolve_with(
        ...
        let max_soul_bytes = file
            .max_soul_bytes
            .unwrap_or(myco_prompts::DEFAULT_MAX_SOUL_BYTES);
...
"#;
    ...
    fn max_soul_bytes_comes_from_the_config_file() {
        ...
        // 64 KiB backstop.
        assert_eq!(resolve(""), myco_prompts::DEFAULT_MAX_SOUL_BYTES);
