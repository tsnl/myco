...
//!
//! The interactive CLI's Ui ([`crate::DEAD_tui::TuiProducer`]) subscribes a
...
//! history (see [`crate::history_events`]).
//!
//! Escape-freedom is structural, not filtered: styling and content are
//! different [`crate::DEAD_tui::TuiEvent`] variants, and the plain encoding simply
...
mod tests {
    ...
    fn console_path_is_the_id_sibling() {
        let session = crate::Session::new("m");
